...
public class HelpCommand implements CommandHandler {
    ...
    public CommandInfo getInfo() {
        ...
        return new CommandInfo(true, null, "Shows a help page.", "viewfinder.command.help", "<empty>", "help");
    }
    ...
    public void execute(Command command) {
        ...
        sender.sendMessage(ChatColor.GREEN + "==========[ Viewfinder Help ]==========");

        PluginCommand registeredCommand = Bukkit.getPluginCommand("viewfinder");
